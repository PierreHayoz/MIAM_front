...
import { getEventBySlug, getEventByDocument } from "@/app/lib/strapi";
  ...
  return (
    <article className="px-4">
      <div className="grid grid-cols-4 gap-2">
        {/* HEADER / INFOS */}
        <header className="col-span-4 md:col-span-1 space-y-3">
          ...
          <div className="text-sm text-MIAMwhite bg-MIAMviolet w-fit rounded-full px-2 py-1">
